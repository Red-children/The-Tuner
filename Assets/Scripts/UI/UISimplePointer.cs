...
public class UISimplePointer : MonoBehaviour
{
    ...
    [Header("基准点")]
    [SerializeField] private Transform transBase;

    [Header("箭头设置")]
    [SerializeField] private float screenMargin = 15f;          // 箭头距离屏幕边缘的距离（可调整）
    [SerializeField] private float targetOffset = 10f;          // 箭头距离目标的距离
    [SerializeField] private float arrowSafeDistance = 20f;     // 箭头自身大小带来的边缘安全距离（新增）
